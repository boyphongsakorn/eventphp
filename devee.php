...
<div class="container">
    ...
    <div style="position: absolute;top: 50%;left: 45%;margin-top: -50px;margin-left: -50px;width: 300px;height: 300px;"-->
      ...
      <button type="button" class="btn btn-primary" onclick="exitevent()">ยืนยัน</button>
    ...
    function exitevent(){
        ...
        function(data, status){
          if(data == '0.1'){
            alert('ไม่เจออุปกรณ์นี้ในการเข้าร่วมงาน')
          }
          if(data == '1'){
