  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm" id="dateselect">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <select class="custom-select" id="statusclass">
        ...
        <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" src="https://event.teamquadb.in.th/report/regevent.php" id="iframewow" name="iframewow"></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        function send() {
            if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value == ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/regevent.php?start=' + document.getElementById('startdate').value;
                if(document.getElementById('statusclass').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "&status="+document.getElementById('statusclass').value
                }
            }else if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value != ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/regevent.php?start=' + document.getElementById('startdate').value + '&end=' + document.getElementById('enddate').value ;
                if(document.getElementById('statusclass').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "&status="+document.getElementById('statusclass').value
                }
            }else{
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/regevent.php';
                if(document.getElementById('statusclass').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "?status="+document.getElementById('statusclass').value
                }
            }
