  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid">
        ...
        <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" src="https://event.teamquadb.in.th/report/bplspecial.php" id="iframewow" name="iframewow"></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        function send() {
            if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value == ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/bplspecial.php?start=' + document.getElementById('startdate').value;
            }else if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value != ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/bplspecial.php?start=' + document.getElementById('startdate').value + '&end=' + document.getElementById('enddate').value ;
            }else{
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/bplspecial.php';
            }
        }
