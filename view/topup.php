  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid">
        ...
        <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" src="https://event.teamquadb.in.th/report/topup.php" id="iframewow" name="iframewow"></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        function send() {
            if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value == ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/topup.php?start=' + document.getElementById('startdate').value;
                ...
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/topup.php?start=' + document.getElementById('startdate').value + '&end=' + document.getElementById('enddate').value ;
                if(document.getElementById('classevent').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += '&eveid='+document.getElementById('classevent').value;
                }
            }else{
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/topup.php';
                if(document.getElementById('classevent').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += '?eveid='+document.getElementById('classevent').value;
                }
            }
