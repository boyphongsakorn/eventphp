    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm" id="dateselect">
                <div class="row">
                    <div class="col-sm">
                        <select class="custom-select" id="classevent">
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ?>
                                    <option value="<?php echo $row["eve_id"] ?>"><? echo $row["eve_name"] ?></option>
                                    <?
                                }
                            }
                            ?>
        ...
        <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" src="https://event.teamquadb.in.th/report/jelist.php" id="iframewow" name="iframewow"></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        function send() {
            if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value == ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/jelist.php?start=' + document.getElementById('startdate').value;
                if(document.getElementById('classevent').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "&eveid="+document.getElementById('classevent').value
                }
            }else if(document.getElementById('startdate').value != "" && document.getElementById('enddate').value != ""){
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/jelist.php?start=' + document.getElementById('startdate').value + '&end=' + document.getElementById('enddate').value ;
                if(document.getElementById('classevent').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "&eveid="+document.getElementById('classevent').value
                }
            }else{
                document.getElementById('iframewow').src = 'https://event.teamquadb.in.th/report/jelist.php';
                if(document.getElementById('classevent').value != "ทั้งหมด"){
                    document.getElementById('iframewow').src += "?eveid="+document.getElementById('classevent').value
                }
            }
