...
<body>
    ...
    <page size="A4" layout="landscape" style="font-family: 'Sarabun', sans-serif;">
            ...
            if(isset($_GET['start']) && !isset($_GET['end'])) {
                ...
                $sql = "SELECT * FROM event_list WHERE eve_timestart BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['start']." 23:59:59'";

            }else if(isset($_GET['start']) && isset($_GET['end'])) {

                $sql = "SELECT * FROM event_list WHERE eve_timestart BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['end']." 23:59:59'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><? echo $row["eve_address"] ?></td>

                        <td><? echo $row["eve_theme"] ?></td>

                        <td><? echo $row["eve_limit"] ?></td>

                        <td><? echo $row["eve_price"] ?></td>

                        <td><? echo $row["eve_timestart"] ?></td>

                        <td><? echo $row["eve_timeend"] ?></td>

                        <td><? echo $row["emp_create"] ?></td>
