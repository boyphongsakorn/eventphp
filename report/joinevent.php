    ...
    <page size="A4" layout="landscape" style="font-family: 'Sarabun', sans-serif;">
            ...
            <table style="width:100%;padding-left: 1%;padding-right: 1%;">
                ...
                <tr>
                    ...
                    <th>อุปกรณ์เข้างาน</th>

                    <th>เงินที่มีอยู่ในงาน<th>
            ...
            if(isset($_GET['start'])){
                ...
                $sql = "SELECT * FROM joinevent WHERE joe_inevent BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['start']." 23:59:59'";

            }else if(isset($_GET['start']) && isset($_GET['end'])) {

                $sql = "SELECT * FROM joinevent WHERE joe_inevent BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['end']." 23:59:59'";

            }else{

                $sql = "SELECT * FROM joinevent";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><? echo $row["euse_id"] ?></td>

                        <td><? echo $row["eve_id"] ?></td>

                        <td><? echo $row["joe_inevent"] ?></td>

                        <td><? echo $row["joe_exitevent"] ?></td>

                        <td><? echo $row["dev_id"] ?></td>

                        <td><? echo $row["joe_money"] ?></td>
