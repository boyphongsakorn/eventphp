...
<body>
    ...
    <page size="A4" layout="landscape" style="font-family: 'Sarabun', sans-serif;">
            ...
            if(isset($_GET['start'])){
                ...
                $sql = "SELECT * FROM payment WHERE pay_datetime BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['start']." 23:59:59'";

            }else if(isset($_GET['start']) && isset($_GET['end'])) {

                $sql = "SELECT * FROM payment WHERE pay_datetime BETWEEN '".$_GET['start']." 00:00:00' AND '".$_GET['end']." 23:59:59'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><? echo $row["pay_bank"] ?></td>

                        <td><? echo $row["pay_money"] ?></td>

                        <td><? echo $row["pay_datetime"] ?></td>
